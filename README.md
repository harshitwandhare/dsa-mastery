...
| 24 | [Divide and Conquer](24-divide-and-conquer.md) | Mergesort against insertion sort, counting inversions, quickselect, median of medians, probability from zero, randomized quicksort in expectation and with high probability, the sorting lower bound, Karatsuba, Strassen, closest pair, KMP and Rabin-Karp |
| 25 | [Dynamic Programming](25-dynamic-programming.md) | The five-step recipe, cut-and-paste proofs, the canonical problem set, optimal binary search trees, pseudo-polynomial bounds, DP on trees and DAGs |
| 26 | [Greedy Algorithms](26-greedy.md) | Exchange arguments, greedy-stays-ahead, activity selection, minimizing lateness, Huffman, MSTs and the cut property, Kruskal, Prim, Boruvka, matroids |
| 27 | [Graphs and Network Flow](27-graphs-and-network-flow.md) | One traversal with four bags, BFS/DFS structure theorems, topological sort, SCCs, tense edges, all four shortest-path algorithms including Johnson, Ford-Fulkerson, max-flow min-cut, modelling with flow |
| 28 | [NP-Completeness](28-np-completeness.md) | P and NP, CircuitSAT and the reduction chain to 3SAT, reductions in the right direction, Cook-Levin, the standard hard problems, writing a hardness proof, approximation ratios, undecidability |
| 29 | [Problem Sets, Worked](29-problem-sets.md) | The six recurring problem shapes worked end to end: reading a running time off awkward code, asymptotics of an expression, ordering 28 functions by growth, writing a recurrence from a counting problem, bounding recurrences by level sums, and four divide-and-conquer design problems |
