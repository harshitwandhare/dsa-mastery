...
def main() -> None:
    ...
    if d0_total and d0_pass < d0_total:
        ...
        sections = {1: "0.1-0.5  running Python, variables, types, strings, booleans",
        ...
        box("YOU ARE ON: Day 0 - Python from zero", [
    ...
    if d1_total and d1_pass < d1_total:
        ...
        box("YOU ARE ON: Day 1 - the Python DSA toolkit", [
    ...
    box("YOU ARE ON: problem practice", [
